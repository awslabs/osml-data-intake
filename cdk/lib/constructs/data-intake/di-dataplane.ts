...
export class DIDataplaneConfig extends BaseConfig {
  ...
  constructor(config: ConfigType = {}) {
    super({
      ...
      LAMBDA_TIMEOUT: 900,
      S3_OUTPUT_BUCKET_NAME: "data-intake-output",
      SNS_INPUT_TOPIC_NAME: "data-intake-input",
      SNS_STAC_TOPIC_NAME: "data-intake-stac-output",
      ...config
    });
  }
}
...
export class DIDataplane extends Construct {
  ...
  constructor(scope: Construct, id: string, props: DIDataplaneProps) {
    ...
    this.diContainer = new Container(this, "DIContainer", {
