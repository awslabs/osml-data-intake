...
/**
 * Configuration properties for the Vpc Construct, defining how the VPC should be setup.
 *
 * @interface VpcProps
 */
export interface VpcProps {
   ...
   *
   * @type {VpcConfig | undefined}
   */
  config?: VpcConfig;
}

/**
 * Vpc is a construct that defines a Virtual Private Cloud.
 */
export class OSMLVpc extends Construct {
   ...
   */
  public readonly config: VpcConfig;
  ...
  /**
   * Constructor for Vpc. Sets up a VPC with or without custom configurations based on the provided properties.
   ...
   */
  private setupVpcEndpoints(props: VpcProps): void {
    let partitionPrefix;
  ...
  private setupFlowLogs(): void {
    const flowLogGroup = new LogGroup(this, "VpcFlowLogsLogGroup", {
    ...
    this.flowLog = new FlowLog(this, "VpcFlowLogs", {
